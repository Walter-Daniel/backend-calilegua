...
export class Migration1731290765272 implements MigrationInterface {
    name = 'Migration1731290765272'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "category" ADD "name" character varying(150) NOT NULL`);
